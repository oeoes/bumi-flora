    ...
    <div class="padding">
        ...
        <div class="row">
            <div class="col-md-12 mb-5">
                <form action="{{ route('records.online_transaction_history') }}" method="get">
                    <div class="row">
                        <div class="col-md-3">
                            <label>Dari</label>
                                    ...
                                    <tr class=" " data-index="0" data-id="17">
                                        <td>
                                            <div class="text-muted text-sm">
                                                <a href="{{ route('records.detail_transaction_history', ['transaction_id' => $item->id, 'dept' => 'ecommerce']) }}">{{ $item->transaction_number }}</a>
                                            </div>
                                        </td>
                                        <td>
