...
@section('page-title', 'Item Keluar')
@section('page-description', 'Daftar item keluar.')
                ...
                <div class="bootstrap-table">
                    <div class="fixed-table-container" style="padding-bottom: 0px;">
                        ...
                        <div class="fixed-table-body">
                            <table id="item-keluar" class="table my-responsive table-theme v-middle table-hover" style="margin-top: 0px;">
                                <thead style="">
                                    <tr>
                                        ...
                                        <th><span class="text-muted">Dari Peny.</span></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class=" " data-index="0" data-id="17">
                                        ...
                                        <td style="">
                                            <span class="item-amount d-sm-block text-sm">
                                                Rp.{{ number_format($item->price * $item->amount_out, 2) }}
                                            </span>
                                        </td>
                                    </tr>
                                    @endforeach
