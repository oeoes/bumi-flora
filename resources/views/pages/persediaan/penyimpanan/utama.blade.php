...
@section('btn-custom')
<div>
    <a href="{{ route('items.export-item', ['dept' => 'utama']) }}" class="btn btn-sm text-muted">
        ...
        <div class="modal-dialog modal-right w-xl">
            <div class="modal-content h-100 no-radius">
                ...
                <div class="modal-body">
                    <div class="p-2">
                        <form action="{{ route('storages.utama') }}" method="get">
                                    ...
                                    <div class="modal-content ">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('records.transfer') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>Dari</label>
                                                    <input name="from" type="text" class="form-control" value="utama" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Ke</label>
