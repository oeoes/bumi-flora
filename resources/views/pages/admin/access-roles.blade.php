    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="dropdown no-arrow">
                <button class="btn btn-sm btn-primary rounded-pill mb-1" data-toggle="modal" data-target="#user-modal"><i class="fas fa-fw fa-user-plus"></i> Add User</button>
                <button class="btn btn-sm btn-info rounded-pill mb-1" data-toggle="modal" data-target="#role-modal"><i class="fas fa-fw fa-users-cog"></i> Add Role</button>
                <button class="btn btn-sm btn-success rounded-pill mb-1" data-toggle="modal" data-target="#permission-modal"><i class="fas fa-fw fa-user-lock"></i> Add Permission</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('access.invite_user') }}" method="post">
                                    @csrf
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-sm btn-primary rounded-pill pl-4 pr-4" value="Add User">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="role-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-sm btn-primary rounded-pill pl-4 pr-4" value="Add role">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="permission-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-sm btn-primary rounded-pill pl-4 pr-4" value="Add permission">
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-sm btn-success rounded-pill mb-1" data-toggle="modal" data-target="#assign-role{{ $key }}"><i class="fas fa-fw fa-user-plus"></i>Assign</button></td>
                                    ...
                                    <div class="modal fade" id="assign-role{{$key}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="submit" class="btn btn-sm btn-primary rounded-pill pl-4 pr-4" value="Assign">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="modal fade" id="edit-role{{$key}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" class="btn btn-sm btn-primary rounded-pill pl-4 pr-4" value="Update">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
